# Loopback-sharding generated-fixture measurement — 2026-08-24

This is an initial Step 10 measurement record for the hermetic Loom loopback
harness. It is correctness-and-overhead evidence for a generated fixture, not
a performance claim for a released model or a Tier-1 acceptance record.
...
The median harness rate is 10.23 completed two-token fixture requests per
...
## Remaining Step 10 evidence

This record does **not** close Step 10. It lacks a provisioned external GGUF
fixture with an immutable signed-manifest/artifact hash, a release-mode run,
process working-set sampling, a second Tier-1 platform result, and any future
versioned compression comparison. A subsequent record must sample process
working set at a documented interval, record the exact fixture and manifest
hashes, and report p50/p95 latency and peak memory for each Tier-1 platform.
