...
- The minimum supported Rust version (MSRV) is **Rust 1.90**.
...
- Dependencies requiring Rust newer than 1.90 cannot be introduced without an ADR that raises the MSRV and documents the migration impact.
